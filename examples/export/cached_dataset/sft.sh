...
swift sft \
    ...
    --metric_for_best_model loss \
    --load_best_model_at_end true \
    --output_dir /data/ljd/Pathology_FM_LLM/expriment/output4paper/sft/qwen3_vl_4b_cpt_sft_kdw${KD_LOSS_WEIGHT}_lorarank${LORA_RANK}_hypocritical \
    --logging_dir /data/ljd/Pathology_FM_LLM/expriment/output4paper/sft/qwen3_vl_4b_cpt_sft_kdw${KD_LOSS_WEIGHT}_lorarank${LORA_RANK}_hypocritical/logs \
    --kd_teacher_model_type conchv1_5 uni2 virchow2 \
    --kd_teacher_model_path /data/ckpt/conchv1.5/pytorch_model_vision.bin /data/ckpt/uni2/pytorch_model.bin /data/ckpt/virchow2/pytorch_model.bin \
    --kd_loss_weight ${KD_LOSS_WEIGHT}
