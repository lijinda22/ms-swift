...
swift sft \
    ...
    --dataset_num_proc 2 \
    --save_total_limit 2 \
    --output_dir /data/ljd/Pathology_FM_LLM/expriment/output/qwen3_vl_2b_cpt_sft_kd \
    --deepspeed zero3 \
    --use_liger_kernel true \
    --attn_impl flash_attention_2 \
    --lora_rank 8 \
    ...
    --vit_gradient_checkpointing false \
    --report_to tensorboard \
    --logging_dir /data/ljd/Pathology_FM_LLM/expriment/output/qwen3_vl_2b_cpt_sft_kd/logs \
    --kd_teacher_model_type conchv1_5 \
    --kd_teacher_model_path /data/ckpt/conchv1.5/pytorch_model_vision.bin \
    --kd_loss_weight 0.05