...
from uni.get_encoder.get_encoder import get_eval_transforms_uni, get_encoder_uni2, get_encoder_virchow2, get_eval_transforms_virchow2

logging.basicConfig(level=logging.INFO)

# --- Config ---
DATASETS_BASE_DIR = "/data/ljd/Pathology_FM_LLM/expriment/classify"
RESULTS_BASE_DIR = "/data/ljd/Pathology_FM_LLM/expriment/classify/results_linear_probe_dynamic_resolution"
...
def main():
    ...
    parser.add_argument("--models", nargs="+", default=["virchow2", "uni2", "conchv1.5"], help="Models to run")
